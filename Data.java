...
public class Data {
    ...
    public static void main(String[] args) {
        ...
        data.addData("soal", "Apa output dari kode berikut?<br>String str = \"Java\";<br>System.out.println(str.length());", "3", "4", "5", "Error", "4", "Java");
        ...
        data.addData("soal", "Apa output dari kode berikut?<br>int a = 5, b = 10;<br>a++;<br>b--; System.out.println(a + b);", "15", "14", "16", "Error", "16", "Java");
        ...
        data.addData("soal", "Apa hasil dari kode berikut?<br>print(2 ** 3)", "5", "6", "8", "9", "8", "Python");
        ...
        data.addData("soal", "Apa output dari kode berikut?<br>x = [1, 2, 3]<br>print(x[3])", "3", "IndexError", "None", "4", "IndexError", "Python");
        ...
        data.addData("soal", "Apa output dari kode berikut?<br>`print(10 // 3)`", "3.33", "3", "Error", "4", "3","Python");
        ...
        data.addData("soal", "Apa output dari kode berikut?<br>#include &lt;iostream&gt;<br>using namespace std;<br>int main(){<br>cout &lt;&lt; \"Hello, World!\" &lt;&lt; endl; return 0;<br>}", "Hello World", "Hello, World!", "Hello World!", "Error", "Hello, World!", "C++");
        ...
        data.addData("soal", "Apa hasil dari kode berikut?<br>#include &lt;iostream&gt;<br>using namespace std;<br>int main(){ int x = 5; int y = 10; x += y;<br>    cout &lt;&lt; x &lt;&lt; endl; return 0; ", "10", "15", "x", "5", "15", "C++");
        ...
        data.addData("soal", "Apa hasil dari kode berikut?<br>#include &lt;iostream&gt;<br>using namespace std;<br>int main(){ int arr[3] = {7, 12, 48};<br>cout &lt;&lt; arr[2] &lt;&lt; endl; return 0; }", "48", "7", "12", "2", "48", "C++");
        ...
        data.addData("soal", "Apa yang akan dicetak oleh kode berikut?<br>let x = \"10\";<br>let y = 10;<br>console.log(x == y);<br>console.log(x === y);", "true, false", "true, true", "false, false", "false, true", "true, false", "Javascript");
        ...
        data.addData("soal", "Apa hasil dari kode berikut?<br>function test(){<br>    console.log(a);<br>    var a = 5; }<br>test();", "5", "Error karena variabel a belum dideklarasikan", "Error karena variabel a tidak diinisialisasi", "undefined", "undefined", "Javascript");
        ...
        data.addData("soal", "Apa hasil dari kode berikut?<br>const a = [1, 2];<br>const b = [...a, 3];<br>console.log(b);", "[1, 2, 3]", "[3, 1, 2]", "[1, 2]", "Error karena spread operator tidak valid", "[1, 2, 3]", "Javascript");
        data.addData("soal", "Apa output dari kode berikut?<br>(function(){<br>    let a = 10;<br>    console.log(a); })();<br>console.log(a);", "10 diikuti oleh 0", "10 diikuti oleh undefined", "10 diikuti oleh ReferenceError", "10 diikuti oleh NaN", "10 diikuti oleh ReferenceError", "Javascript");
        ...
        data.addData("soal", "Apa yang akan terjadi jika kode berikut dijalankan?<br>const obj = { a: 10, b: () =&gt; {<br>        console.log(this.a); },<br>    c: function() { console.log(this.a); } };<br>obj.b(); obj.c();", "undefined dan 10", "undefined dan undefined", "10 dan 10", "Error pada obj.b()", "undefined dan 10", "Javascript");
        data.addData("soal", "Mana pernyataan yang benar tentang eksekusi kode berikut?<br>let a = 5;<br>const increment = (x = 10) =&gt; x + 1;<br>a = increment();<br>console.log(a);", "Nilai a tetap 5 karena parameter default tidak berlaku", "Nilai a akan menjadi 6 karena a diubah oleh fungsi", "Error karena parameter default hanya bekerja dengan var", "Nilai a akan menjadi 11 karena parameter default digunakan", "Nilai a akan menjadi 11 karena parameter default digunakan", "Javascript");
