...
public class Data {
        ...
        public void addData(String table, Object... params) {
                ...
                if (table.equalsIgnoreCase("soal")) {
                        ...
                        queryInsert = """
                                        INSERT INTO pemain (nama, skor_terakhir, skor_tertinggi)
                                        VALUES (?, ?, ?)
                                        """;
                } else {
        ...
        public void questions() {
                ...
                addData("soal", "Apa fungsi dari keyword class dalam Java?", "Menghentikan eksekusi program",
                                "Mendeklarasikan sebuah kelas", "Membuat array",
                                "Mendeklarasikan variabel", "Mendeklarasikan sebuah kelas", "Java");
                addData("soal", "Apa ekstensi file untuk program Java?", ".java", ".class", ".jar", ".exe",
                                ".java", "Java");
                addData("soal", "Manakah tipe data yang digunakan untuk menyimpan angka desimal?", "int", "float",
                                "char", "boolean", "float", "Java");
                addData("soal", "Apa hasil dari perintah berikut? System.out.println(10 + 5);", "10", "5", "15",
                                "Error", "15", "Java");
                addData("soal",
                                "Apa output dari kode berikut?<br>String str = \"Java\";<br>System.out.println(str.length());",
                                "3", "4", "5", "Error", "4", "Java");
                addData("soal", "Apa yang terjadi jika main() tidak dideklarasikan sebagai static?",
                                "Program akan berjalan normal", "Error pada runtime",
                                "Error saat kompilasi", "Tidak ada yang terjadi", "Error saat kompilasi", "Java");
                addData("soal", "Bagaimana cara membuat array dengan 10 elemen bertipe int?", "int arr[] = {10};",
                ...
                addData("soal", "Apa yang dimaksud dengan Overloading dalam Java?",
                ...
                addData("soal", "Apa tujuan dari keyword final pada variabel di Java?",
                ...
                addData("soal", "Apa yang dimaksud dengan Generics di Java?",
                ...
                addData("soal", "Apa tujuan utama dari Garbage Collector di Java?",
                ...
                addData("soal", "Apa perbedaan utama antara HashMap dan TreeMap di Java?",
                ...
                addData("soal", "Apa fungsi dari keyword def dalam Python?", "Mendeklarasikan fungsi",
                                "Mendeklarasikan variabel", "Menjalankan fungsi",
                                "Menentukan tipe data", "Mendeklarasikan fungsi", "Python");
                addData("soal", "Bagaimana cara mencetak teks 'Hello World' di Python?",
                                "System.out.println('Hello World')", "echo 'Hello World'", "print('Hello World')",
                                "console.log('Hello World')", "print('Hello World')", "Python");
                addData("soal", "Apa ekstensi file untuk program Python?", ".py", ".java", ".class", ".pyt", ".py",
                                "Python");
                addData("soal", "Manakah tipe data yang digunakan untuk menyimpan teks di Python?", "int",
                                "string", "float", "bool", "string", "Python");
                addData("soal", "Apa hasil dari kode berikut?<br>print(2 ** 3)", "5", "6", "8", "9", "8",
                                "Python");
                addData("soal", "Apa library Python untuk manipulasi data?", "Numpy", "Pandas", "Scikit-learn",
                                "Semua benar", "Semua benar", "Python");
                addData("soal", "Apa metode untuk menambahkan elemen ke list di Python?", "add()", "insert()",
                                "append()", "push()", "append()", "Python");
                addData("soal", "Apa perbedaan antara list dan tuple?", "List tidak dapat diubah, tuple dapat",
                                "Tuple tidak dapat diubah, list dapat",
                                "Tidak ada perbedaan", "Tuple hanya untuk angka",
                                "Tuple tidak dapat diubah, list dapat", "Python");
                addData("soal", "Apa output dari kode berikut?<br>x = [1, 2, 3]<br>print(x[3])", "3", "IndexError",
                                "None", "4", "IndexError", "Python");
                addData("soal", "Apa arti dari `*args` dalam sebuah fungsi?",
                ...
                addData("soal", "Apa fungsi dari `len()` dalam Python?", "Menghapus elemen list",
                ...
                addData("soal", "Apa itu dictionary di Python?", "Tipe data seperti array",
                                "Tipe data key-value pairs", "Tipe data immutable", "Tipe data berbentuk tuple",
                                "Tipe data key-value pairs", "Python");
                addData("soal", "Apa fungsi dari `lambda` dalam Python?", "Mendeklarasikan class",
                                "Mendeklarasikan fungsi anonymous", "Menginisialisasi variabel",
                                "Membuat loop", "Mendeklarasikan fungsi anonymous", "Python");
                addData("soal", "Apa output dari kode berikut?<br>`print(10 // 3)`", "3.33", "3", "Error", "4",
                                "3", "Python");
                addData("soal", "Apa itu Python Virtual Environment?", "Lingkungan fisik untuk Python",
                ...
                addData("soal", "Manakah tipe data berikut yang digunakan untuk menyimpan bilangan pecahan?",
                ...
                addData("soal", "Pernyataan apa yang digunakan untuk mencetak output ke layar?", "printf",
                ...
                addData("soal",
                                ...
                                "10", "15", "x", "5", "15", "C++");
                addData("soal", "Apa fungsi dari keyword return di dalam fungsi C++?", "Menyimpan variabel",
                                "Mengakhiri fungsi dan mengembalikan nilai", "Mencetak nilai", "Membuat loop",
                                "Mengakhiri fungsi dan mengembalikan nilai", "C++");
                addData("soal", "Apa yang dimaksud dengan pointer di C++?",
                ...
                addData("soal",
                                ...
                                "48", "7", "12", "2", "48", "C++");
                addData("soal", "Bagaimana cara membuat komentar di C++?", "/* Ini komentar", "# Ini komentar",
                ...
                addData("soal", "Cara yang benar untuk mendeklarasikan array di C++ adalah...", "int nilai{10};",
                ...
                addData("soal", "Apa efek dari penggunaan kata kunci explicit pada konstruktor di C++?",
                ...
                addData("soal", "Apa yang dimaksud dengan fungsi virtual dalam C++?",
                ...
                addData("soal", "Apa tujuan dari fungsi console.log() di JavaScript?",
                ...
                addData("soal", "Manakah dari pernyataan berikut yang benar tentang operator === di JavaScript?",
                ...
                addData("soal",
                                ...
                                "Javascript");
                addData("soal", "Apa fungsi dari setTimeout() dalam JavaScript?",
                ...
                addData("soal", "Apa perbedaan utama antara null dan undefined di JavaScript?",
                                ...
                                "null adalah objek yang kosong, sedangkan undefined adalah variabel yang belum diinisialisasi",
                                "Javascript");
                addData("soal", "Apa perbedaan utama antara let dan var di JavaScript?",
                ...
                addData("soal", "Apa fungsi dari try-catch di JavaScript?",
                ...
                addData("soal", "Apa yang dimaksud dengan fungsi callback di JavaScript?",
                ...
                addData("soal", "Apa yang dimaksud dengan \"closure\" dalam JavaScript?",
                ...
                addData("soal", "Apa kepanjangan dari HTML?", "Hyper Text Markup Language",
                                "High Text Markup Language", "Hyper Text Machine Language",
                                "Hyper Tool Markup Language", "Hyper Text Markup Language", "HTML");
                addData("soal", "Tag HTML mana yang digunakan untuk membuat teks tebal?", "<bold>", "<strong>",
                                "<b>", "<t>", "<b>", "HTML");
                addData("soal", "Tag HTML mana yang digunakan untuk baris baru?", "<br>", "<lb>", "<line>",
                                "<break>", "<br>", "HTML");
                addData("soal", "Apa tujuan dari tag &lt;title&gt; dalam HTML?",
                ...
                addData("soal", "Tag HTML mana yang digunakan untuk membuat daftar tanpa nomor?", "<ol>", "<ul>",
                                "<list>", "<li>", "<ul>", "HTML");
                addData("soal", "Apa tujuan dari tag &lt;p&gt; dalam HTML?", "Untuk membuat tautan",
                                "Untuk membuat paragraf", "Untuk membuat baris baru", "Untuk menampilkan gambar",
                                "Untuk membuat paragraf", "HTML");
                addData("soal", "Tag HTML mana yang digunakan untuk menyisipkan gambar?", "<img>", "<image>",
                                "<picture>", "<graphics>", "<img>", "HTML");
                addData("soal", "Atribut apa yang digunakan untuk menentukan URL gambar pada tag &lt;img&gt;?", "src",
                                "alt", "href", "link", "src", "HTML");
                addData("soal", "Apa tujuan dari atribut `href` pada tag &lt;a&gt;?", "Menentukan alamat hyperlink",
                                "Menentukan warna teks", "Menentukan posisi tautan", "Menambahkan teks alternatif",
                                "Menentukan alamat hyperlink", "HTML");
                addData("soal", "Tag HTML mana yang digunakan untuk membuat header atau judul?",
                                "<h1> hingga <h6>", "<header>", "<head>", "<title>", "<h1> hingga <h6>", "HTML");
                addData("soal", "Apa perbedaan antara tag &lt;ol&gt; dan &lt;ul&gt;?", "Tidak ada perbedaan",
                ...
                addData("soal", "Tag HTML mana yang digunakan untuk memasukkan baris horizontal di halaman?",
                                "<hr>", "<br>", "<line>", "<border>", "<hr>", "HTML");
                addData("soal", "Apa fungsi dari atribut `lang` dalam tag &lt;html&gt;?",
                                ...
                                "HTML");
                addData("soal", "Tag HTML mana yang digunakan untuk menyisipkan video?", "<video>", "<media>",
                                "<embed>", "<movie>", "<video>", "HTML");
                addData("soal", "Tag HTML mana yang digunakan untuk menyisipkan file audio?", "<audio>", "<sound>",
                                "<music>", "<media>", "<audio>", "HTML");

                // Soal-soal kategori CSS
                addData("soal", "Apa kepanjangan dari CSS?", "Cascading Style Sheets", "Creative Style Sheets",
                                "Computer Style Sheets", "Colorful Style Sheets", "Cascading Style Sheets", "CSS");
                addData("soal", "Apa fungsi utama dari CSS?", "Membuat struktur dokumen HTML",
                ...
                addData("soal", "Bagaimana cara menyisipkan CSS langsung di dalam dokumen HTML?",
                ...
                addData("soal", "Atribut HTML apa yang digunakan untuk menambahkan CSS langsung ke elemen?",
                                "style", "css", "class", "id", "style", "CSS");
                addData("soal", "Apa tujuan dari file eksternal CSS?", "Mengatur struktur dokumen HTML",
                ...
                addData("soal", "Apa sintaks yang benar untuk mengubah warna teks menjadi merah di CSS?",
                                "color: red;", "text-color: red;", "font-color: red;", "background-color: red;",
                                "color: red;", "CSS");
                addData("soal", "Apa tujuan dari properti `margin` dalam CSS?",
                ...
                addData("soal", "Bagaimana cara memilih elemen dengan ID tertentu dalam CSS?", "#idName",
                                ".idName", "idName", "&idName", "#idName", "CSS");
                addData("soal", "Apa fungsi dari properti `z-index` dalam CSS?", "Mengatur posisi vertikal elemen",
                ...
                addData("soal", "Apa fungsi dari properti `display` dalam CSS?", "Mengontrol visibilitas elemen",
                ...
                addData("soal", "Bagaimana cara membuat teks menjadi tebal menggunakan CSS?", "font-weight: bold;",
                                "text-style: bold;", "font-style: bold;", "font-bold: true;", "font-weight: bold;",
                                "CSS");
                addData("soal", "Apa yang dilakukan properti `position: absolute;` dalam CSS?",
                ...
                addData("soal", "Apa perbedaan antara `padding` dan `margin` dalam CSS?",
                ...
                addData("soal", "Apa tujuan dari pseudo-class `:hover` dalam CSS?",
