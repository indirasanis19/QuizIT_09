...
public class Data {
    ...
    public static void main(String[] args) {
        ...
        data.addData("soal", "Apa yang akan terjadi jika kode ini dijalankan?\n#include <iostream>\nusing namespace std;\n\ntemplate <typename T>\nT add(T a, T b){\n    return a + b;\n}\n\nint main(){\n    cout << add<int>(2, 3) << endl;\n    cout << add<double>(2.5, 3.5) << endl;\n    return 0;\n}", "Mencetak 5 dan 6.0 menggunakan template", "Error karena template tidak diimplementasikan dengan benar", "Undefined behavior karena tipe data tidak cocok", "Tidak ada output", "Mencetak 5 dan 6.0 menggunakan template", "C++");
