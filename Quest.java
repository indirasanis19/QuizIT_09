...
public class Quest extends JFrame {
    ...
    private void initialize(Dimension mainFrameSize) {
        ...
        for (JButton button : buttons) {
            ...
            button.setText("<html><p style='width: 600px; word-wrap: break-word; text-align:center;'>" + button.getText() + "</p></html>");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            Quest quest = new Quest("Design Tools", new Dimension(900, 600));
